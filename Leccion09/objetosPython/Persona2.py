...
class Persona2:
    # Se inicializa la instancia de clase
    def __init__(self, nombre, apellido, edad, *valores, **terminos): # En los argumentos, pasamos una lista * de alores
...
persona2 = Persona2('Jesús', 'Vaca', 56, '3121070968', 2, 5,8, m='Manzanana', p='Pera')    # Se crea el objeto con la instancia
                                                                 # de clase Persona2
print(f'Objeto Persona2 {persona2.nombre} {persona2.apellido} {persona2.edad} {persona2.valores} {persona2.terminos}')
